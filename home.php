...
<?php } ?>
    ...
    <div id="home">
        <div class="container">
            <div class="row">
                <div class="col-left">
                    <h1 style="margin: 60px;"><strong>Shelter Connect</strong></h1>
                    <img src="cat.jpg" class="img-responsive" alt="Cat img">
                    <p>Search for pets, and schedule an appointment to play with them!</p>
                </div>
            </div>
        </div>
    </div>
